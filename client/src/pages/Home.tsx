...
export default function Home() {
  ...
  return (
    <div className="site-shell">
      ...
      <footer className="site-footer"><div className="footer-brand"><div className="footer-ticket">NETWORK / 06</div><img src={markAsset} alt="" className="brand-mark" /><span>FAST<br /><em>MOVMENT</em></span></div><p>Two sides.<br />One city moving.</p><div className="footer-links"><a href="mailto:hello@fastmovment.com">hello@fastmovment.com <MoveUpRight size={15} /></a><a href="https://instagram.com" target="_blank" rel="noreferrer">Instagram <Instagram size={15} /></a></div><div className="footer-bottom"><span>© 2026 FASTMOVMENT</span><span>ATHENS / EVERYWHERE</span><a href="#top">BACK TO TOP ↑</a></div></footer>
    </div>
  );
}
